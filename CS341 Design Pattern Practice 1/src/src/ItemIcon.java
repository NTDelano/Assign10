...
public class ItemIcon implements Icon {
	...
	public ItemIcon(int valA, int valB, int diameter) {
		...
		//super.paintComponent(this, g2, 0, 0);
	}
	...
	public void paintIcon(Component comp, Graphics g, int x, int y) {
		...
		Rectangle2D rect = fm.getStringBounds("A:"+str+" B:"+strB, g2);
		...
		g2.setFont(f);
		//System.out.print("x="+x+" y="+y);
		//System.out.println("sumx="+(x + offsetX)+" sumy="+(y + offsetY));
		g2.drawString("A:"+str+" B:"+strB, x + offsetX, y + offsetY);
	}
}